...
import FullLogo from 'public/assets/icons/dataant_fullLogo.svg'
import SingleLogo from 'public/assets/icons/dataant_singleLogo.svg'
...
function Logo({ single = false, sx }) {
  ...
  const singleLogo = <SingleLogo fill={PRIMARY_MAIN} />;
  const fullLogo = <FullLogo fill={PRIMARY_MAIN} />;
