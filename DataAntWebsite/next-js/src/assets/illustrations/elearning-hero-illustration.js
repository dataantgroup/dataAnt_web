  ...
  return (
    ...
    >
        ...
        <Label
          ...
          icon={
            <Image
              ...
              disabledEffect
              alt="python"
              src="/assets/icons/platforms/pyTorch.png"
      ...
      <Box {...varUp} component={m.div} sx={{ zIndex: 8, right: 90, position: 'absolute' }}>
        <Icon
          ...
          content={<Image
            ...
            disabledEffect
            alt="python"
            src="/assets/icons/platforms/openAI.png"
            sx={{ width: 56, height: 68 }}
          />}
      ...
      <Box {...varDown} component={m.div} sx={{ zIndex: 8, position: 'absolute' }}>
        <Icon
          color={BLUE}
          content={<Typography sx={{ ...styleIconContent, color: 'common.white' }}>AI</Typography>}
          sx={{
            transform: 'scale(1.1) translate(-135px, -75px) rotate(15deg)',
          }}
        />
      </Box>
